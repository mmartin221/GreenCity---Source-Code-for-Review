...
<section class="ls with_bottom_border">
			...
			<section class="ls section_padding_top_50 section_padding_bottom_50 columns_padding_10">
				<div class="container-fluid">
					...
					<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>add-timetable">
							...
							<div class="col-md-8">
								<div class="with_border with_padding">
									...
									<div class="row form-group">
										...
										<div class="col-lg-9">
											<input type="text" class="form-control" name="sessionEventName" required="">
										</div>
									</div>
								...
								<!-- 			<input type="text" id="from" name="from" /> -->
											 <input type="text" class="form-control"  id="from" name="startDate" required="" value=""/>
									...
									<div class="row form-group">
										...
										<div class="col-lg-9">
											...
											<input type="text" class="form-control"  id="to" name="endDate" required="" value=""/>
											<span class="form-error required" id="err_email"></span>
										</div>
									</div>
						           <div class="row form-group">
							      ...
							      <div class='col-lg-9 input-group date' id='starttime'>
									...
									<div class="row form-group">
										...
										<div class="col-lg-9">
											<input type="text" step="0.01" name="maxnoPeopleInSession" class="form-control num_only" required>
										</div>
									</div>
									...
									<div class="row form-group">
										...
										<div class="col-lg-9">
											<input type="text" class="form-control" name="recyclingCenterName" required="">
										</div>
									</div>
									<div class="row form-group">
										<label class="col-lg-3 control-label">Recycling Center Address: </label>
										<div class="col-lg-9">
											<input type="text" class="form-control" name="recyclingCenterAddress" required="">
										</div>
									</div>
										<div class="row form-group">
									...
									<div class="row">
										<div class="col-sm-12 text-right">
											<button type="submit" class="theme_button wide_button">Save Timetable</button>
