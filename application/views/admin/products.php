								...
								<div class="table-responsive">
									<table class="table table-striped table-bordered">
										...
										<?php foreach ($result as $key => $value) { 
											$category = $this->user->getDataById('categorymaster', array('id' => $value['categoryId']));
											$image = $this->user->getDataById('productimage', array('productId' => $value['id']));
										...
										?>
											<tr class="item-editable">
												...
												<td class="media-middle">
													<a class="theme_button wide_button " href="<?php echo base_url(); ?>edit-product/<?= $value['id']; ?>">Edit</a>
												</td>
											</tr>
										<?php } ?>
