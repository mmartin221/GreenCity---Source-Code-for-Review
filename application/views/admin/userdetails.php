					...
					<div class="row">
						<div class="col-md-6">
							<ol class="breadcrumb darklinks">
								...
								<?php if(!empty($bookingUserDetails)){?>
								<li class="active"><?=$bookingUserDetails[0]['sessionEventName'];?></li>
										<?php } ?>
							</ol>
						</div>
						<!-- .col-* -->
			...
			<section class="ls section_padding_top_50 section_padding_bottom_50 columns_padding_10">
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							<?php if(!empty($bookingUserDetails)){?>
							<h3><?=$bookingUserDetails[0]['sessionEventName'];?></h3>
						<?php } ?>
						</div>
						<!-- .col-* -->
					</div>
							...
							<div class="with_border with_padding">
								...
								<div class="table-responsive">
									<table class="table table-striped table-bordered">
										...
										<?php foreach ($bookingUserDetails as $key => $value) {  ?>
											<tr class="item-editable">
												...
												<td class="media-middle">
													<?php echo date('d/m/Y h:i A', strtotime($value['created'])); ?>
												</td>
												<td class="media-middle">
													<?php echo date('d/m/Y', strtotime($value['bookingDate'])); ?>
												</td>
